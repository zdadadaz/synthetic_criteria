...
srun python ./crossEncoder/finetunet5.py --triples_path data/tripple/tripple_psu_temp.tsv  \
                                         --learning_rate 1e-3 \
                                         --output_model_path ./crossEncoder/models/3b/psutemp_med_model_63_3b_ance \
...
srun python ./crossEncoder/finetunet5_tc_val.py --triples_path data/tripple/tripple_tc_63_3b_ance.tsv  \
                                         ...
                                         --learning_rate 1e-3 \
                                         --output_model_path ./crossEncoder/models/3b/tc_psutemp_med_model_63_3b_ance \
                                         --per_device_train_batch_size 16 \
                                         --gradient_accumulation_steps 8 \
                                         --base_model ./crossEncoder/models/3b/psutemp_med_model_63_3b_ance \
                                         --gradient_checkpointing True \
                                         --model_parallel 1

### inference
outname='3b_ct_psutemp_medt5_ance'
base_model='./crossEncoder/models/3b/tc_psutemp_med_model_63_3b_ance'
