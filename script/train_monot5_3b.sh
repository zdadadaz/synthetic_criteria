...
srun python ./crossEncoder/finetunet5_tc_val.py --triples_path ./data/tripple/tripple_tc_63_3b_ie.tsv  \
                                          --triples_path_eval ./data/tripple/tripple_ct21_63_3b_ie_small.tsv  \
                                         --learning_rate 1e-5 \
                                         --output_model_path ./crossEncoder/models/3b/tc_med_model_63_3b_ie_lr5\
                                         --per_device_train_batch_size 8 \
                                         --gradient_accumulation_steps 16 \
                                         --base_model castorini/monot5-3b-med-msmarco \
                                         --gradient_checkpointing True
